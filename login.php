...
<meta charset="UTF-8">
 ...
 <script src="script.js"></script>
    <title>S'inscrire d'artisan</title>
    <style>
...
<body>
 ...
 <form action="" method="post" onSubmit="return validate();">
    ...
    <div class="mb-2">
      <label for="exampleFormControlInput6" class="form-label"> <i class="fab fa-facebook-square"></i>Facebook</label>
      <input type="text" class="form-control" id="exampleFormControlInput6"  required>
    </div>
    <div class="mb-2">
...
<option value="Khémisset">
    ...
    <div class="mb-2">
      <label for="service" class="form-label"> <i class="fa fa-wrench"></i>Votre service</label>
    ...
    <div class="mb-2">
       <label for="Description" class="form-label"><i class="fas fa-audio-description"></i>Description</label>
       <textarea class="form-control" id="Description" rows="3" placeholder="parlez-nous de votre service"  required></textarea>
    </div>
