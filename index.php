...
<head>
  ...
  <style>
    <?php include "classbootstrap.css" ?><?php include "style.css" ?><?php include "header.css" ?><?php include "tv.css" ?><?php include "footer.css" ?><?php include "readmore.css" ?><?php include "comment.css" ?>h2,
    h3,
    h4,
    h5 {
      color: #15324d;
    ...
    <div id="text1">
      ...
      <h5><span id="arty"><span>ARTY.ma</span></span> permet à tous les artisans de
        ...
        <span id="dots">...</span><span id="more">publicités
          ...
          artisan le plus proche de leur lieu de résidence.</span>
      </h5>
